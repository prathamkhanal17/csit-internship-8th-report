...
## 2. Formatting Standards (Apply to Dummy Content)

- **Font:** Times New Roman.

- **Font Sizes:** \* Chapter Headings: 16 (Bold).

- Section Headings: 14 (Bold).

- Sub-section Headings: 12 (Bold).
...
- **Page Numbering:** Roman (i, ii...) for preliminary pages; Numeric (1, 2...) starting from Chapter 1.
...
2.  **Certificate Page:** Must include Mentor’s Recommendation, Supervisor’s Recommendation, and Examiners’ Approval Letter.
...
6.  **Lists:** Figures, Tables, and Abbreviations.
...
- 3.2 Weekly Log (Technical activities performed).
...
- **References:** APA style (cited works).

- **Bibliography:** Works studied but not cited.
