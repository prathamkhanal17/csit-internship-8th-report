...
Got it — I’ll **extend it naturally**, keeping the same academic/technical tone and LaTeX structure, without changing your intent. Here’s a **slightly longer and richer version** with more depth, practical detail, and clarity:
...
\begin{itemize}
    \item Monitored distribution switches deployed across the Kathmandu Valley area to verify device availability and link status \parencite{zabbix2023}.
