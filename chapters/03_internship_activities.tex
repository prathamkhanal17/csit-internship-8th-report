...
\begin{itemize}
    \item \textbf{Network Monitoring:} Continuous monitoring of network health was performed using the Zabbix platform \parencite{zabbix2023}. This included observing uptime, latency, and packet loss for distribution switches in the Kathmandu Valley area.
...
\begin{itemize}
    ...
    \item Created a network diagram summarizing internship activities.
    \item Presented learning outcomes to the NOC manager and supervisor in accordance with technical communication standards \parencite{kumar2022}.
\end{itemize}
\end{minipage} \\ \hline
...
\begin{itemize}
    ...
    \item Analyzed real-time graphs for latency and packet loss to detect congestion during peak traffic hours (7~PM -- 10~PM).
...
\begin{itemize}
    \item Established connection to switch consoles using PuTTY and serial cables.
...
\begin{itemize}
    \item Accessed remote monitoring servers securely using the Secure Shell (SSH) protocol.
...
\begin{itemize}
    ...
    \item Observed and verified fiber splicing procedures using fusion splicers to ensure low-loss connections, complying with industry recommendations \parencite{itu2021}.
\end{itemize}
